...
- 部署到靜態站時，TWSE OpenAPI、TWSE MIS、Google News RSS 與 AI sentiment proxy 都需要額外的同源 proxy，否則瀏覽器無法直接讀官方端點。
- Finnhub 目前只覆蓋美股 watchlist 與部分新聞，不是全量多市場即時源。
